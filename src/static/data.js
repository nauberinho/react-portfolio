const GO_TO_REPOSITORY = 'Go to repository', GO_TO_WEBSITE = 'Go to website', GO_TO_REPOSITORY_FRONT_END = 'Go to repository (Front End)', GO_TO_REPOSITORY_BACK_END = 'Go to repository (Back End)', GO_TO_SOURCE_CODE = 'Gå till källkod';
...
const projects = [
  ...
  },
  {
    ...
    links: [{url: 'http://www.satoeurope.com/nordic/home.aspx', text: GO_TO_WEBSITE}]
  },
  {
  ...
  },
  {
    ...
    description: "",
    links: [{url: "https://bitbucket.org/niknau/pdgeon/src/", text: GO_TO_REPOSITORY}]
  },
  {
    ...
    description:
      ...
      links: [{ url: "https://github.com/nauberinho/100-GitHub-Repositories", text: GO_TO_REPOSITORY }]
  },
  {
    ...
    description:
      "",
      links: [{url: "https://bitbucket.org/niknau/apply-for-jobs-spa/src/master/", text: GO_TO_REPOSITORY_FRONT_END},
      {url: "https://bitbucket.org/niknau/apply-for-jobs-be/src", text: GO_TO_REPOSITORY_BACK_END}
    ]
  },
  {
    ...
    description:
      "",
      links: [{ url: "https://bitbucket.org/niknau/apply-for-jobs-be/src", text: GO_TO_REPOSITORY }]
  },
  {
    ...
    description:
      "",
      links: [{ url: "https://github.com/nauberinho/nauberinho.github.io/tree/master/youWeather", text: GO_TO_SOURCE_CODE}]
  },
  {
    ...
    description:
      "",
      links: [{ url: "https://nauberinho.github.io/Authentication_inl_3/", text: GO_TO_WEBSITE }]
  },
  {
    title: "Firebase chat SPA",
    techniques: ['firebase', 'react'],
    description: 'Created a chat application in React and Firebase Realtime Database.',
    links: [{ url: "https://nauberinho.github.io/Chat,%20inl%202/index.html", text: GO_TO_WEBSITE }]
  }
];
